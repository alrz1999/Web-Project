...
export async function logInPatient(data) {
  ...
  formBody = formBody.join("&");
  return fetch("http://localhost:9000/api/customers/login", {
    method: "POST",
    headers: {
      "Content-Type": "application/x-www-form-urlencoded;charset=UTF-8",
    },
...
export async function logInDoctor(data) {
  ...
  formBody = formBody.join("&");
  return fetch("http://localhost:9000/api/doctors/login", {
    method: "POST",
    headers: {
      "Content-Type": "application/x-www-form-urlencoded;charset=UTF-8",
    },
...
export async function getAppointment(data) {
  ...
  formBody = formBody.join("&");
  return fetch("http://localhost:9000/api/doctors/appointments", {
    method: "POST",
    headers: {
      "Content-Type": "application/x-www-form-urlencoded;charset=UTF-8",
    },
